import { PremiumConfig, DriverInterface } from './types';
 ...
 */
export async function createPremiumSystem(config: PremiumConfig): Promise<PremiumSystem> {
 ...
 */
function validateConfig(config: PremiumConfig): void {
 ...
 */
async function loadDriver(config: PremiumConfig): Promise<DriverInterface> {
